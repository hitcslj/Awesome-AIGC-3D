...
| **PivotMesh** | 2024 | arXiv 2024 | Coarse-to-fine mesh scaffolding | [📄](https://arxiv.org/abs/2405.16890) | - | - | [📖](./citations/pivotmesh.txt) |
| **EdgeRunner** | 2024 | arXiv 2024 | Hybrid AR-latent mesh generation pipeline | [📄](https://arxiv.org/abs/2409.18114) | - | - | [📖](./citations/edge_runner.txt) |
...
| **SpaceMesh** | 2024 | arXiv 2024 | Continuous halfedge latent diffusion; ultra-fast | - | - | - | [📖](./citations/space_mesh.txt) |
...
| **TexFusion** | 2023 | arXiv 2023 | Cross-view aggregated texture fusion | - | - | - | [📖](./citations/texfusion.txt) |
...
| **FlashTex** | 2024 | arXiv 2024 | Fast text-to-texture generation | - | - | - | [📖](./citations/flashtex.txt) |
...
| Method | Year | Venue | Highlight | 📄 | 💻 | 🌐 | 📖 |
|--------|------|-------|-----------|-----|-----|-----|-----|
| **SMPL** | 2015 | SIGGRAPH Asia 2015 | Skinned multi-person linear body model | - | - | - | [📖](./citations/smpl.txt) |
...
| **SMPLicit** | 2021 | CVPR 2021 | Implicit clothing conditioned on SMPL parameters | - | - | - | [📖](./citations/smplicit.txt) |
...
| **AvatarCLIP** | 2022 | SIGGRAPH 2022 | CLIP-guided text-to-avatar generation | - | - | - | [📖](./citations/hong2022avatarclip.txt) |
| **Get3DHuman** | 2023 | arXiv 2023 | Tri-plane/SDF GAN for full-body humans | - | - | - | [📖](./citations/get3dhuman.txt) |
...
| **DreamHuman** | 2023 | arXiv 2023 | SDS + imGHUM body prior for text-to-human | - | - | - | [📖](./citations/dreamhuman.txt) |
...
| **TADA!** | 2024 | CVPR 2024 | SMPL-X + texture with LBS-ready rigging | - | - | - | [📖](./citations/tada.txt) |
...
| **3DGS-Avatar** | 2024 | arXiv 2024 | Deformable 3DGS bound to skinning weights | - | - | - | [📖](./citations/3dgsAvatar.txt) |
...
| Method | Year | Venue | Highlight | 📄 | 💻 | 🌐 | 📖 |
|--------|------|-------|-----------|-----|-----|-----|-----|
| **ATISS** | 2021 | NeurIPS 2021 | Autoregressive transformer for room layouts | - | - | - | [📖](./citations/atiss.txt) |
| **ProcTHOR** | 2022 | CVPR 2022 | Procedural interactive houses for embodied AI | - | - | - | [📖](./citations/procthor.txt) |
| **Pose2Room** | 2022 | arXiv 2022 | Activity-driven affordance-aware room layout | - | - | - | [📖](./citations/nie2022pose2room.txt) |
| **DiffuScene** | 2024 | arXiv 2024 | Diffusion + retrieval for furnished indoor scenes | - | - | - | [📖](./citations/diffuscene.txt) |
...
| **AnyHome** | 2024 | arXiv 2024 | Open-vocabulary text-to-house scene generation | - | - | - | [📖](./citations/anyhome.txt) |
...
| **3D-GPT** | 2025 | arXiv 2025 | Procedural modeling as language-conditioned programs | - | - | - | [📖](./citations/3dgpt.txt) |
...
| Method | Year | Venue | Highlight | 📄 | 💻 | 🌐 | 📖 |
|--------|------|-------|-----------|-----|-----|-----|-----|
| **Text2Light** | 2022 | arXiv 2022 | Text-conditioned HDR panorama for skybox/lighting | - | - | - | [📖](./citations/text2light.txt) |
| **Text2Room** | 2023 | arXiv 2023 | 2D diffusion lifted to textured room meshes | - | - | - | [📖](./citations/text2room.txt) |
| **Infinigen** | 2023 | CVPR 2023 | Photorealistic procedural natural world generation | - | - | - | [📖](./citations/raistrick2023infinite.txt) |
| **CityDreamer** | 2024 | arXiv 2024 | Unbounded urban synthesis with stuff + thing fields | - | - | - | [📖](./citations/cityDreamer.txt) |
